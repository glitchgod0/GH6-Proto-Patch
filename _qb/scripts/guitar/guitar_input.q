...
script 0xc8e862b1 
	...
	if (<type> = competitive)
		if (($competitive_rules = faceoff) || ($competitive_rules = momentum) || ($competitive_rules = elimination) || ($competitive_rules = p8_pro_faceoff) || ($competitive_rules = team_faceoff) || ($competitive_rules = team_elimination) || ($competitive_rules = team_momentum))
			return \{true}
		endif
	endif
	return \{false}
