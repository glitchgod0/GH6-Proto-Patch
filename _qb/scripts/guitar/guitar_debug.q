...
script debug_launch_song \{song = !q1768515945
	...
	if (<game_mode> = career)
		...
		formattext checksumname = 0xdd8a3748 'c_%s' s = <song_name>
		gig_struct = ($<0xdd8a3748>)
	...
	ui_event event = menu_change data = {state = uistate_play_song starttime = <start_time> selected_level = <venue_load>}
endscript
