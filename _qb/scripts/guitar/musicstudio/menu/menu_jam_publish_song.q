...
script jam_upload_song_failed \{dialog = 0}
	...
	switch <dialog>
		...
		case 1
		upload_dialog = qs(0x4a9c5369)
		case 2
		formattext textname = text qs(0x698624e7) s = ($ghtunes_minimum_note_count)
		upload_dialog = <text>
		case 3
		minimum_seconds = ($ghtunes_minimum_song_time / 1000)
		casttointeger \{minimum_seconds}
		formattext textname = text qs(0xbb7a376c) s = <minimum_seconds>
		upload_dialog = <text>
		case 4
		upload_dialog = qs(0xa05d4600)
		case 5
		upload_dialog = qs(0xe3e00947)
		case 6
		if isxenonorwindx
			upload_dialog = qs(0x05c128be)
		elseif isps3
			upload_dialog = qs(0x59311c62)
		endif
		case 7
		upload_dialog = qs(0x7cc9a727)
		case 8
		if isxenonorwindx
			upload_dialog = qs(0x46c0de53)
		elseif isps3
			upload_dialog = qs(0xd77197ca)
		endif
		case 9
		if isxenonorwindx
			upload_dialog = qs(0x7f2de14b)
		elseif isps3
			upload_dialog = qs(0xd77197ca)
		endif
		case 10
		...
		upload_dialog = <text>
		case 11
		upload_dialog = qs(0xb00b065d)
		case 12
		upload_dialog = qs(0x0d21ae3f)
		case 13
		if isxenonorwindx
		...
		case 14
		upload_dialog = qs(0x3f4876e2)
		case 15
		upload_dialog = qs(0x799bb901)
		case 16
		upload_dialog = qs(0xe3e00947)
		case 17
...
script jam_upload_check_dialog \{dialog = 0}
	...
	switch <dialog>
		...
		formattext \{textname = title
			qs(0xe6cd2b61)}
		formattext textname = upload_dialog qs(0xba4ed697) s = (<slot> + 1)
		func = jam_upload_song_to_slot
		func_params = {<...> replace}
		case 1
		formattext \{textname = title
			qs(0x9d4a3853)}
		formattext textname = upload_dialog qs(0xc8aa2bee) s = (<slot> + 1)
