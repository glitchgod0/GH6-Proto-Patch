...
script ui_options_cheats_new_sound_events 
	switch (<sound>)
		...
		switch (<key>)
			case green
			soundevent \{event = audio_ui_cheat_select_green}
			case red
			soundevent \{event = audio_ui_cheat_select_red}
			case yellow
			soundevent \{event = 0xd1609cc6}
			case blue
			soundevent \{event = audio_ui_cheat_select_blue}
		endswitch
		case down
		switch (<cheat>)
			case unlocked
