worst_female_appearance = {
	...
	cas_guitar_pickguards_2 = {
		desc_id = gtr5_pickguard_01
		size_kb = 12
	}
	cas_guitar_pickguards_3 = {
		desc_id = gtr37_pguard01
		size_kb = 12
	}
	cas_guitar_pickguards_4 = {
		desc_id = gtr40_pgard
		size_kb = 12
	}
	cas_guitar_pickguards_5 = {
		desc_id = gtr1_sch_pickguard_01
		size_kb = 12
	}
	cas_guitar_pickups_2 = {
		desc_id = gtr76_pickupb
		size_kb = 32
	}
	cas_guitar_pickups_3 = {
		desc_id = gtr76_pickupa_b
		size_kb = 32
	}
	cas_guitar_pickups_4 = {
		desc_id = gtr76_pickupb_b
		size_kb = 32
	}
	cas_guitar_pickups_5 = {
	...
	cas_guitar_bridges_2 = {
		desc_id = gtr33_hardware01z
		size_kb = 32
	}
	cas_guitar_bridges_3 = {
		desc_id = gtr37_hardware
		size_kb = 32
	}
	cas_guitar_bridges_4 = {
		desc_id = gtr_hardware02
		size_kb = 32
	}
	cas_guitar_bridges_5 = {
	...
	cas_female_acc_left_2 = {
		desc_id = f_goth_acc_lstrapglove
		size_kb = 48
	}
	cas_female_acc_left_3 = {
		desc_id = f_goth_acc_laceglv_l
		size_kb = 48
	}
	cas_female_acc_left_4 = {
		desc_id = f_rock_acc_lglove
		size_kb = 44
	}
	cas_female_acc_left_5 = {
	...
	cas_female_acc_right_2 = {
		desc_id = f_goth_acc_rpndrbuckles
		size_kb = 60
	}
	cas_female_acc_right_3 = {
		desc_id = f_punk_acc_rbands
		size_kb = 56
	}
	cas_female_acc_right_4 = {
		desc_id = f_clsc_accs_rbracelet
		size_kb = 52
	}
	cas_female_acc_right_5 = {
	...
	cas_female_acc_face_2 = {
		desc_id = f_clsc_glasses_avtr
		size_kb = 36
	}
	cas_female_acc_face_3 = {
		desc_id = f_clsc_glasses_round
		size_kb = 36
	}
	cas_female_acc_face_4 = {
		desc_id = f_goth_glasses_ggls
		size_kb = 36
	}
	cas_female_acc_face_5 = {
		desc_id = f_metl_glasses_nathan
		size_kb = 36
	}
	cas_female_acc_ears = {
	...
	cas_female_acc_ears_2 = {
		desc_id = f_punk_acc_ring_03
		size_kb = 12
	}
	cas_female_acc_ears_3 = {
		desc_id = f_punk_acc_ring
		size_kb = 8
	}
	cas_female_acc_ears_4 = {
	...
	cas_bass_pickguards_2 = {
		desc_id = bs_sch_t_pga
		size_kb = 16
	}
	cas_bass_pickguards_3 = {
		desc_id = bs_sch_030_pga
		size_kb = 12
	}
	cas_bass_pickguards_4 = {
		desc_id = bass132_pg
		size_kb = 12
	}
	cas_bass_pickguards_5 = {
		desc_id = bass133_pg
		size_kb = 12
	}
	cas_bass_pickups = {
...
worst_male_appearance = {
	...
	cas_male_facial_hair_2 = {
		desc_id = m_clsc_fhair_country
		size_kb = 40
	}
	cas_male_facial_hair_3 = {
		desc_id = m_metl_fhair_zzbeard
		size_kb = 40
	}
	cas_male_facial_hair_4 = {
		desc_id = m_rock_fhair_stub
		size_kb = 36
	}
	cas_male_facial_hair_5 = {
