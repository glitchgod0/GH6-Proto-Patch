cas_female_shoes = [
	...
	}
	{
		...
		mesh = `models/car/female/f_punk_shoe_canvas`
		materials = [
	...
	{
		desc_id = f_spnr_shoe_vansh_dreamskull
		frontend_desc = qs(0xf36439da)
		mesh = `models/car/female/f_spnr_shoe_vansh_dreamskull`
		random_weight = 1.0
		genre = [
			rock
		]
	...
	}
	{
		...
		swatch_for = f_spnr_shoe_vansh_dreamskull
		swatch_texture = `tex/models/characters/car/sponsor/swach_f_vans01`
	}
	{
		desc_id = f_spnr_shoe_vansh_dotbw
		frontend_desc = qs(0x336f2ee0)
		mesh = `models/car/female/f_spnr_shoe_vansh_dotbw`
		random_weight = 1.0
		genre = [
			rock
		]
		swatch_for = f_spnr_shoe_vansh_dreamskull
		swatch_texture = `tex/models/characters/car/sponsor/swach_f_vans02`
	}
	{
		desc_id = f_spnr_shoe_vansh_pinkstripe
		frontend_desc = qs(0x295f2717)
		mesh = `models/car/female/f_spnr_shoe_vansh_pinkstripe`
		random_weight = 1.0
		genre = [
			rock
		]
	...
	{
		desc_id = f_spnr_shoe_vansl_dreamskull
		frontend_desc = qs(0x232f4230)
		mesh = `models/car/female/f_spnr_shoe_vansl_dreamskull`
		random_weight = 0.0
		genre = [
			rock
		]
	...
	}
	{
		...
		swatch_for = f_spnr_shoe_vansl_dreamskull
		swatch_texture = `tex/models/characters/car/sponsor/swach_f_vans01`
	}
	{
		desc_id = f_spnr_shoe_vansl_dotbw
		frontend_desc = qs(0xd0c4a06b)
		mesh = `models/car/female/f_spnr_shoe_vansl_dotbw`
		random_weight = 1.0
		genre = [
			rock
		]
	...
	{
		desc_id = f_spnr_shoe_vansl_pinkstripe
		frontend_desc = qs(0x8c5cf647)
		mesh = `models/car/female/f_spnr_shoe_vansl_pinkstripe`
		random_weight = 1.0
		genre = [
			rock
		]
	...
	{
		desc_id = f_spnr_shoe_converse01
		frontend_desc = qs(0xb032c25b)
		mesh = `models/car/female/f_spnr_shoe_converse01`
		random_weight = 1.0
		genre = [
			rock
		]
	...
	{
		desc_id = f_spnr_shoe_converse02
		frontend_desc = qs(0x6e9dae2c)
		mesh = `models/car/female/f_spnr_shoe_converse02`
		random_weight = 1.0
		genre = [
			rock
		]
		swatch_for = f_spnr_shoe_converse01
		swatch_texture = `tex/models/characters/car/sponsor/swach_converse02`
	}
	{
		desc_id = f_spnr_shoe_converse03
		frontend_desc = qs(0x8a491d4f)
		mesh = `models/car/female/f_spnr_shoe_converse03`
		random_weight = 1.0
		genre = [
			rock
		]
		swatch_for = f_spnr_shoe_converse01
		swatch_texture = `tex/models/characters/car/sponsor/swach_converse05`
	}
	{
		desc_id = f_spnr_shoe_converse04
		frontend_desc = qs(0x9534830d)
		mesh = `models/car/female/f_spnr_shoe_converse04`
		random_weight = 1.0
		genre = [
			rock
		]
