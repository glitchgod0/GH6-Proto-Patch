...
script userselectrightanalogleft 
	...
	if (<current_chapter> = none)
		<current_chapter> = quest_chapter_axel
		setglobaltags savegame = ($primary_controller) career_progression_tags params = {current_chapter = <current_chapter>}
...
script userselectleftanalogup 
	...
	setplayerinfo <player> projected_song_stars = 5
	getplayerinfo <player> band
	setbandinfo <band> projected_song_stars = 5.0
	gamemode_gettype
	if (<type> = practice)
