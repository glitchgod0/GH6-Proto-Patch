...
script band_lobby_focus_outfit 
	requireparams \{[
		...
		all}
	printf channel = band_lobby qs(0x00897a66) p = <player> v = <submenu_index>
	get_savegame_from_player player = <player>
	formattext checksumname = submenu_data 'band_lobby_submenu_data_%i' i = <submenu_index>
	update_temporary_ghrocker slot = <submenu_index> savegame = <savegame> character_id = <outfit_character_id> outfit = <outfit_id>
	formattext checksumname = id_checksum 'temporary_ghrocker_%d' d = <submenu_index> addtostringlookup = true
	set_chosen_character_id player = ($<submenu_data>.player) id = <id_checksum> savegame = <savegame>
...
script band_lobby_unfocus_outfit 
	requireparams \{[
		...
		all}
	printf channel = band_lobby qs(0xcc491fe6) p = <player> v = <submenu_index>
endscript
...
script band_lobby_cancel_select_outfit 
	requireparams \{[
		...
		all}
	printf qs(0xf05f3a98) d = <player> v = <submenu_index>
	get_savegame_from_player player = <player>
	formattext checksumname = submenu_data 'band_lobby_submenu_data_%i' i = <submenu_index>
	set_chosen_character_id player = ($<submenu_data>.player) id = <outfit_character_id> savegame = <savegame>
	persistent_band_refresh_changed_characters
...
script band_lobby_build_select_outfit_submenu 
	requireparams \{[
		...
		all}
	printf qs(0xc04c4a78) d = <player> v = <submenu_index>
	get_savegame_from_player player = <player>
	formattext checksumname = submenu_data 'band_lobby_submenu_data_%i' i = <submenu_index>
	getplayerinfo ($<submenu_data>.player) chosen_character_id
	character_id = <chosen_character_id>
	...
	formattext checksumname = select_outfit 'select_outfit%i' i = <submenu_index>
	...
	band_lobby_change_menu action = forward menu = select_outfit player = <player> submenu_index = <submenu_index> no_forced
endscript
